...
export function NewView({ onOpenShow }: NewViewProps) {
  return (
    <div className="space-y-10">
      <h1 className="text-4xl font-bold tracking-tight text-foreground">[หัวข้อ]</h1>

      <section aria-label="รายการแนะนำ" className="grid grid-cols-1 gap-6 lg:grid-cols-2">
      ...
      <section aria-labelledby="top-shows-heading">
        ...
        >
          <span id="top-shows-heading">[ชื่อหมวด]</span>
